        ...
        {['rename', 'delete', 'share'].includes(value) && (
          <DialogFooter className="flex flex-col gap-3 md:flex-row">
            <Button
              ...
              className="h-[52px] flex-1 rounded-full bg-white text-light-100 hover:bg-transparent shadow-sm hover:shadow-md"
            >
              Cancel
            </Button>
            ...
            <Button
              ...
              className="rounded-full bg-[#ff6b6b] text-white hover:bg-[#ff8787] font-medium !mx-0 h-[52px] w-full flex-1"
            >
