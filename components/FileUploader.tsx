...
const FileUploader = ({ ownerId, accountId, className }: Props) => {
  ...
  return (
    <div {...getRootProps()} className="cursor-pointer">
      <input {...getInputProps()} />
      <Button type="button" className={cn('flex items-center justify-center gap-2 rounded-full bg-[#F87171] px-10 h-[52px] shadow-lg text-white font-medium hover:bg-[#ef4444] transition-all', className)}>
        <Image
